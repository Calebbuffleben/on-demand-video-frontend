...
api.interceptors.request.use(async (config)=>{
    // Get token from local storage - use the standard 'token' key
...
const subscriptionService = {
    ...
    getCurrentSubscription: async ()=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2d$connection$2f$service$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get('/subscriptions/current');
        return response.data;
    },
    // Create a checkout session
    createCheckoutSession: async (priceId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2d$connection$2f$service$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post('/subscriptions/create-checkout', {
            priceId
        });
        return response.data;
    },
    ...
    cancelSubscription: async (subscriptionId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2d$connection$2f$service$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["default"].put(`/subscriptions/${subscriptionId}/cancel`);
        return response.data;
    },
    // Get available subscription plans
    getSubscriptionPlans: async ()=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2d$connection$2f$service$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get('/subscriptions/plans');
        return response.data;
    }
};
...
const DashboardPage = ()=>{
    ...
    const fetchSubscription = async ()=>{
        const subscription = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2d$connection$2f$subscriptions$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["default"].getCurrentSubscription();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a98a94._.js.map